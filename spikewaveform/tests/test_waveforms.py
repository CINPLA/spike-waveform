from spikewaveform.core import calculate_waveform_features, cluster_waveform_features
...
def test_calculate_waveform_features_half_width_mean():
    ...
    expected_half_width_mean = 9.0411345322e-05 # s
    success = abs(computed_half_width_mean[0] -
                  expected_half_width_mean) < 1e-10
...
def test_calculate_waveform_features_peak_to_peak_mean():
    ...
    expected_peak_to_peak_mean = 0.00013333333 # s
...
def test_calculate_waveform_features_average_firing_rate():
    ...
    expected_average_firing_rate = (float(3) / 10)
...
#                          half_width_mean, peak_to_peak_mean, n_clusters=6)
#     assert pytest.raises(ValueError, cluster_waveform_features,
#                          half_width_mean, peak_to_peak_mean, n_clusters=1)
